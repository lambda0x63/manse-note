...
import { checkPassword, setAuthSession, isAuthenticated } from '@/lib/auth'
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-4 pr-12 rounded-2xl border-2 transition-all duration-200 focus:outline-none focus:ring-4 text-base touch-manipulation ${
                      error 
                        ...
                        : 'border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 focus:ring-primary/20 focus:border-primary'
                    }`}
                    style={{ 
                      fontSize: '16px',
